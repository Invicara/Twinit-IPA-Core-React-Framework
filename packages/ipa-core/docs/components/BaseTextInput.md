...
- `inputProps`: _(required)_ Object of props related to the input, they are used to pass properties to the underlying `input` tag or to the input component provided in props (see component property below).
