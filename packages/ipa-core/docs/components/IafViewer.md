...
|modelVersionId |String|Pass the model's version number as a string.                                     |              |
|enableNotifications |Boolean|Enable info, warning and error notifications for model loading.            |`true`        |
