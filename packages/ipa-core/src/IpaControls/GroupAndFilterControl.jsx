...
const GroupAndFilterControl = ({
  ...
  const availableGroups = () =>
    _.difference(distinctPropNames(fetchedEntities), nonGroupableProperties);

  const availableFilters = () =>
    _.difference(distinctPropNames(fetchedEntities), nonFilterableProperties)
