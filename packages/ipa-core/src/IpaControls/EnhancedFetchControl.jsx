...
const controlsMap = {
    ...
    '<<HIERARCHY>>': () => <div style={{margin: 10}}>Deprecated hierarchy control. Please use Scripted Linked Selects instead</div>, //TODO Remove when fully deprecated
};
...
export const getControlComponent = ({query}) => controlsMap[query]
