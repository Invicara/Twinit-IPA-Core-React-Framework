              ...
              >
                ...
                {slicePoints.map(point => (
                  <div key={point.id}>
                    ...
                    >
                      <strong>{line1DataForTooltip[0].id}</strong> [
                      {line1DataForTooltip[0].data[point.index].y}]
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <strong>{line2DataForTooltip[0].id}</strong> [
                      {line2DataForTooltip[0].data[point.index].y}]
                    </div>
                  </div>
                ))}
              </div>
