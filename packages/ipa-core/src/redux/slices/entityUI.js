...
import {
  SimpleTabbedTableFactory,
  SimpleTableFactory,
  SimpleTableGroupFactory,
} from '../../IpaControls/private/simple-table';
...
const addApplicationActionComponent = component =>
  (applicatonActionComponents[component.name] = component.component);
let applicatonDataComponents = {};
const addApplicationDataComponent = component =>
  (applicatonDataComponents[component.name] = component.component);
...
const entityUI = createSlice({
  ...
  initialState,
  reducers: {
    setApplicationActionComponents: (state, { payload: entityActionComponents }) => {
      state.applicationActionComponents = entityActionComponents;
    },
    setApplicationDataComponents: (state, { payload: entityDataComponents }) => {
