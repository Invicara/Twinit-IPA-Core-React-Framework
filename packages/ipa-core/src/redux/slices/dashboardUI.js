...
const addApplicationDashboardComponent = component =>
  (applicatonDashboardComponents[component.name] = component.component);
...
const dashboardsSlice = createSlice({
  ...
  initialState,
  reducers: {
    setApplicationComponents: (state, { payload: dashboardComponents }) => {
