...
test('Navigator config should use default', async () => {
  ...
  const DigitalTwinNavigatorTest = decorateWithMockAppProvider(
    () => <RenderHandlerByPath path={currentPath}></RenderHandlerByPath>,
    {},
    userConfigMerged,
    currentPath,
    sampleSelectedItems
...
const assetHandlerExpected = {
  ...
  config: {
    ...
    entitySelectionPanel: {
      ...
      defaultGroups: ['Mark', 'Type Mark', 'Level'],
    },
    tableView: {
      component: {
        name: 'EntityListView',
      ...
      Edit: {
        ...
        component: {
          ...
          groups: {
            ...
            Identification: ['Type Mark', 'Mark'],
            Location: ['Level', 'Room Name', 'Room Number'],
            Classification: ['dtCategory', 'dtType'],
          },
          okButtonText: 'Save',
        },
      },
    ...
    data: {
      'Asset Properties': {
        ...
        component: {
          ...
          hidden: [],
          groups: {
            Identification: ['Mark', 'Type Mark', 'Manufacturer', 'Description'],
            'Sensor Information': ['SensorIDs'],
            Location: ['Level', 'Room Name', 'Room Number'],
            'System Information': ['System Name', 'System Classification', 'Workset'],
            Classification: [
              'dtCategory',
              'dtType',
              'ClassificationCode',
            ...
            'Revit Data': ['Revit Family', 'Revit Type', 'revitGuid', 'revitId'],
          },
        },
      },
      'Asset Performance': {
      ...
      'Model Element': {
        'Element Properties': {
          ...
          component: {
            ...
            groupClassName: 'simple-table-group-name',
            groups: {
              'Base Properties': ['Revit Family', 'Revit Type', 'SystemelementId'],
            },
          },
        },
      },
      ...
      Space: {
        'Space Properties': {
          ...
          component: {
            ...
            hidden: ['Area Num'],
            groups: {
              'Location Information': ['Level', 'Name', 'Number', 'Area'],
              'Sensor Information': ['SensorIDs'],
              'Revit Information': [
                'Revit Family',
                'Revit Type',
      ...
      Asset: {
        ...
        Create: {
          ...
          component: {
            ...
            showGroupNames: true,
            groups: {
              'Asset Properties': ['Floor', 'Mark', 'Room'],
              Product: ['Manufacturer', 'Model'],
              Classification: ['Revit Family', 'Revit Type', 'dtCategory', 'dtType'],
              General: [
                'Date',
                'DateTime',
                'Image Url',
        ...
        Edit: {
          ...
          component: {
            name: 'EntityModal',
            requiredProperties: ['dtCategory', 'dtType'],
            hierarchySelects: {
              id: 'edithierarchyselects',
              query: '<<SCRIPTED_LINKED_SELECTS>>',
              display: 'Category',
            ...
            showGroupNames: true,
            hidden: ['dtCategory', 'dtType', 'Revit Blob'],
            disabledInMulti: ['Revit Family', 'Revit Type'],
            groups: {
              'Asset Properties': ['Containing Floor', 'Mark', 'Room Number', 'BA Name'],
              Product: ['Manufacturer', 'Model'],
              Classification: ['Revit Type', 'Revit Family'],
              General: ['Date', 'Image Url', 'Matterport Url'],
            },
            okButtonText: 'Save',
          },
        },
      ...
      Space: {
        ...
        Create: {
          ...
          component: {
            ...
            showGroupNames: true,
            groups: {
              'Space Properties': ['Floor', 'Number', 'Type', 'Area'],
            },
            okButtonText: 'Save',
          },
        },
