...
export const InviteForm = ({
  ...
  return (
    <div className="invite-form">
        ...
        <div className={clsx('invite-form-content fade', showForm && 'shown')}>
          ...
          <div className="email-entry">
            ...
            <div className="align-right">
              <SimpleButton disabled={sendingInvites} onClick={addEmail}>
                Add Email
              </SimpleButton>
            </div>
          </div>
              ...
              <ul>
                {allEmails.map(e => (
                  <UserCard
                    ...
                    removeUserText=""
                    cancelText=""
                    onRemoveUser={() => removeInviteEmail(e)}
                  />
                ))}
              </ul>
            )}
          ...
          <div className="align-right">
            <SimpleButton
              disabled={
                (allEmails.length === 0 && selectedUserGroups.length === 0) || sendingInvites
              }
              onClick={resetForm}
            >
              Clear
      ...
      {renderOverlay && (
        <div className={clsx('invite-form-overlay fade', showOverlay && 'shown')}>
