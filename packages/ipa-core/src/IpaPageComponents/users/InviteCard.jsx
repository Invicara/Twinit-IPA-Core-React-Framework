    ...
    <li className="user-group-list-item invite">
      <div className="card-row1">
        <div className="invite-user-info">
          {existingUser && (
            <div className={clsx('user-full-name', isCurrentUser && 'current-user')}>
        ...
        <div className="invite-info">
          <div className={clsx('invite-expires', expired && 'expired')}>
            <span className="bold info-span">Expires:</span> {expiresDate}
          </div>
          <div className="invite-usergroup">
            <span className="bold info-span">UserGroup:</span> {invite._usergroup._name}
          </div>
        </div>
        {showActions && !isDoingAction && (
          <div className="card-actions">
            {isCurrentUser && !expired && (
              <i className="fas fa-check" onClick={() => confirmAction('ACCEPT')}></i>
            )}
      ...
      {isDoingAction && (
        <div className="card-row2">
          ...
          <div>
            <a href="#" onClick={actionConfirmed}>
