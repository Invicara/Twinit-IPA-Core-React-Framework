...
export const DatasourceCard = ({
  ...
  return (
    <li className="datasource-list-item">
      <div className="card-row1">
        ...
        <div className="datasource-info">
          ...
          {orchestrator._class === 'SCHEDULED' && (
            <div className="info-point">
              <span style={{ fontWeight: 'bold' }}>Next Run: </span>
              <span className="info-value">
                {getFormattedDate(orchestrator._orchschedule.next_scheduled_time)}
              </span>
            </div>
          )}
          <div className="info-point">
          ...
          <div className="info-point">
            ...
            <span className={clsx('info-value', getLatestRunStatus() === 'ERROR' && 'error')}>
              {getLatestRunStatus()}
            </span>
          </div>
        </div>
        {!isDoingAction && (
          <div className="datasource-card-options">
            ...
            {orchestrator._class === 'SCHEDULED' && (
              <i className="far fa-calendar-alt" onClick={toggleSchedule}></i>
            )}
            {!readonly && removeOrchestrator && (
              <i className="fas fa-trash" onClick={toggleDelete}></i>
            )}
          </div>
        )}
      </div>
        ...
        <div className="card-row2">
          ...
          {showDelete && (
            <>
              ...
              <a href="#" onClick={deleteOrchestrator}>
                <i className="fas fa-check"></i>Remove Datasource
              </a>
