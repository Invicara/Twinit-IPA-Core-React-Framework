...
export const DatasourceScheduleTable = ({
  orchestrator,
  readonly = true,
  ...
  return (
    <table className="datasource-schedule-table">
      <thead>
      ...
      <tbody>
        <tr>
          ...
          <td className="buttons">
            {!editing && !readonly && !isSaving && (
              <a href="#" onClick={editSchedule}>
                edit
              </a>
            )}
            {editing && (
              <a href="#" onClick={cancelEditSchedule}>
                cancel
              </a>
            )}
            {editing && (
