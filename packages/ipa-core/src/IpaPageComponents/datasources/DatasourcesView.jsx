    ...
    return (
      <div className="datasources-view">
        ...
        <div className="datasources-list">
          {this.state.orchestrators.map(o => {
            return (
              <DatasourceCard
                key={o.id}
                orchestrator={o}
                runs={this.state.runs[o.id]}
                readonly={!this.props.handler.config.allowManageDatasources}
                onDidUpdate={this.getOrchestrators}
                removeOrchestrator={
                  this.props.handler.config.allowDeleteDatasources ? this.removeOrchestrator : false
                }
              />
            );
          })}
