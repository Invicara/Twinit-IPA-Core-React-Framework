  ...
  return (
    <li className="omapi-card">
      ...
      <div className="card-row2">
        ...
        <div>
          <GenericButton text="Try Me" styles={tryMeStyles} onClick={tryMe} />
        </div>
      </div>
      {expanded && (
        <div className="card-row3">
          <div className="path-config-items">
                          ...
                          <div className="config-card-val">
                            ...
                            <div className="val-container">
                              <input
                                ...
                                onInput={e => updateState(pathVars, k, e.target.value, setPathVars)}
                              ></input>
                          ...
                          <div className="config-card-val">
                            ...
                            <div className="val-container">
                              <input
                                ...
                                onInput={e =>
                                  updateState(queryParams, k, e.target.value, setQueryParams)
                                }
                              ></input>
                              <div className="config-card-desc">
            ...
            <div className="even-row-space">
              {path.docs && path.docs['Request Body'] && (
                <div className={clsx({ 'config-card': true, 'config-card-half': true })}>
                  <div className="config-card-title">Request Body</div>
                  <OMAPICardError error={requestBodyError} />
                  <hr />
                  <div>
                    {Object.keys(flattenObject(path.docs['Request Body'])).map(k => {
                      return (
                        <div key={k}>
                          <div className="config-card-val">
                            <div className="val-name">{k}</div>
              ...
              >
                ...
                <hr />
                {path.docs && path.docs['Response Body'] && (
                  <div>
                    {Object.keys(flattenObject(path.docs['Response Body'])).map(k => {
                      return (
                        <div key={k}>
                          <div className="config-card-val">
                            <div className="val-name">{k}</div>
                ...
                <div className="config-body">
                  {fetching && (
                    <div className="resp resp-ok fetching">
