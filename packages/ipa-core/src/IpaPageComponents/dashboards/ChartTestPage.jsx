      ...
      >
        <Select
          ...
          options={scripts.map(s => {
            return { label: s.title, value: s.name };
          })}
        />
        <Select
        ...
        <br />
        <a href="https://nivo.rocks/components?filter=SVG" target="_blank" rel="noreferrer">
          Nivo Chart Documentation
        </a>
        <br />
        <a href="https://nivo.rocks/components?filter=SVG" target="_blank" rel="noreferrer">
          Inivcara Chart Extensions
        </a>
      </div>
