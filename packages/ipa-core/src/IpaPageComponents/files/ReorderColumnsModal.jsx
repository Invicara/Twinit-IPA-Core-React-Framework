...
const ReorderColumnsModal = props => {
  ...
  return (
    <GenericModal
      ...
      modalBody={
        <div className="reorder-columns-modal">
                ...
                {columns
                  ? columns.map((doc, index) => {
                      ...
                      if (doc != undefined)
                        if (doc.active)
                          return (
                            <li key={doc.name} onDragOver={() => onDragOver(index)}>
                              <div
                                className={`drag ${doc.selected ? 'selected' : 'unselected'}`}
                                draggable
          ...
          <div className="reorder-columns-buttons">
            ...
            <button onClick={() => ApplyChanges()} className="load">
              Apply Changes
            </button>
          </div>
        </div>
