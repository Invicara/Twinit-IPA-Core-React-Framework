...
const component = renderer.create(
  <DocumentTable 
    ...
    tableConfig= {Default.tableConfig}
  />,
);

it('should load document table correctly', () => {
  let tree = component.toJSON();
  expect(tree).toMatchSnapshot();
});

expect(component.root.findByType(DocumentTable).props.documents[0].documentData.name).toBe('istockphoto-1180542165-612x612.jpeg');
expect(component.root.findByType(DocumentTable).props.documents[0].documentData._id).toBe('62275fb83c44ab1996c214e8');