...
class IfefSpinner extends React.Component {
  componentDidMount() {
    ...
    let iconElement = ReactDOM.findDOMNode(this);
    let spinnerName = this.props.icon;
  ...
  render() {
    let classes = classnames('spinner', 'spinner-' + this.props.icon, this.props.customClasses);
    return <i className={classes}></i>;
  }
}

IfefSpinner.propTypes = {
  customClasses: PropTypes.string,
  icon: PropTypes.string,
};

IfefSpinner.defaultProps = {
  customClasses: '',
  icon: 'ios',
};

export default IfefSpinner;
