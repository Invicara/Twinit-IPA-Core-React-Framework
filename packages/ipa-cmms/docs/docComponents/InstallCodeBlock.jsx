...
export const InstallCodeBlock = (() => {
   ...
   return <BrowserOnly>{() => <div className="codeBlockContainer_J+bg">
          <div className="codeBlockContent_csEI bash">
               <pre className="prism-code language-bash codeBlock_rtdJ thin-scrollbar" style={{color: 'rgb(57, 58, 52)', backgroundColor: 'rgb(246, 248, 250)'}}>
                    <code className="codeBlockLines_1zSZ">
                         <span className="token-line" style={{color: 'rgb(57, 58, 52)'}}>
                              ...
                              <span className="token plain"> {moduleName}/ipa-cmms</span>
                         </span>
                    </code>
               </pre>
          </div>
