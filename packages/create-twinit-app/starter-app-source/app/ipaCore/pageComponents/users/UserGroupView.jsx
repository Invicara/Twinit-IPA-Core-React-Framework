...
import {StackableDrawer} from '@invicara/ipa-core/modules/IpaDialogs'
import { SimpleTextThrobber, RadioButtons } from '@invicara/ipa-core/modules/IpaControls'
...
class UserGroupView extends React.Component {
    ...
    async getAllUserGroups(selectedUserGroup) {
      ...
      return new Promise((resolve, reject) => {
        ...
        // get only the 'user_group' userType because other types of usergroups can exist
        IafPassSvc.getUserGroups({_userType: 'user_group'}, null, {includeAll: true}).then( (ugs) => {
          
          let groups = ugs._list.filter(ug => ug._userAttributes.project_workspace._id === this.props.selectedItems.selectedProject._id)
